...
def printButtons(all_buttons_frame):
    ...
    botao_sistema = Botao('Sistema : Ax = B', lambda: comandoResolverSistemaAxB(resultado_frame,
                                                                                receber_matrizA.getMatriz(),
                                                                                receber_matrizB.getMatriz()))
    botao_matriz_magica = Botao(
        'Matriz Mágica', lambda: comandoMatrizMagica(resultado_frame))
...
janela_principal.configure(borderwidth=4, relief="solid", bg='#AFEEEE')
...
all_buttons_operatoin_frame = Frame(
    conteudo, bg='#00ff00', borderwidth=3, relief='raised')
...
receber_matrizA.receber('Matriz A : ',
                        lambda: comandoDetA(
                            resultado_frame, receber_matrizA.getMatriz()),
                        lambda: comandoMatrizTransA(
                            resultado_frame, receber_matrizA.getMatriz()),
...
receber_matrizB.receber('Matriz B : ',
                        lambda: comandoDetA(
                            resultado_frame, receber_matrizB.getMatriz()),
                        lambda: comandoMatrizTransB(
                            resultado_frame, receber_matrizB.getMatriz()),
